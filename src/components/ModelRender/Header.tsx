...
const Header: React.FC<HeaderProps> = ({ status }) => {
  return (
    <Navbar className="bg-light bg-opacity-75 border-bottom border-secondary">
      ...
      <div className="ms-auto d-flex align-items-center">
        ...
        <div className="bg-light rounded-circle border border-secondary" style={{ width: '36px', height: '36px' }}>
